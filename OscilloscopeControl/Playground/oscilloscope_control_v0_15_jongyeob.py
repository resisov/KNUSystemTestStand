...
class Tektronix:
    ...
    def resistry_reset(self):
        ...
        # ch1 data
        self.inst.write('DATA:SOU CH1')  # Set source to channel 1
...
parser.add_argument('--scan_start', type=float, default=-240, help='Scan start value')
parser.add_argument('--scan_stop', type=float, default=-240, help='Scan stop value')
